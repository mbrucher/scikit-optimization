...
#    c.append(y_limit)
    ...
    #f = oofun(lambda z: z[0]**1.5, input = ooFuncs[-1], d = lambda z:[1.5*z[0]**0.5, 0, 0, 0, 0], name = 'objFunc')
    #f = oofun(lambda z: z[0], input = ooFuncs[-1], d = lambda z:[1, 0, 0, 0, 0], name = 'objFunc')
    ...
    for j, solver in enumerate(solvers):
        ...
        r = p.solve(solver,  plot=0, showFeas=1, maxTime = 150, iprint = 100, ftol=1e-6, xtol=1e-6)
