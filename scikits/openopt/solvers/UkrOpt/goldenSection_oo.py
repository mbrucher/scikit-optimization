...
from scikits.openopt.Kernel.setDefaultIterFuncs import SMALL_DELTA_X, IS_MAX_ITER_REACHED
...
#    solutionType = 'best'# 'right', 'left' are also allowed
    ...
    def __solver__(self, p):
        ...
        if p.kernelIterFuncs.has_key(SMALL_DELTA_X): p.kernelIterFuncs.pop(SMALL_DELTA_X)
        a,  b,  f = p.lb,  p.ub,  p.f
