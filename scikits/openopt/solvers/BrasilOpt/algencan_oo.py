...
#        algencan.param['epsfeas'] = p.contol#TODO: check me
#        #algencan.param['MAXOUTIT'] = p.maxIter
#        algencan.param['maxoutit'] = 50#p.maxIter
#        algencan.param['maxtotit'] = p.maxIter

#        algencan.param['maxtotfc'] = p.maxFunEvals
#        algencan.param['epsopt'] = p.gtol
#        algencan.param['rhoauto'] = True
#
#        x0 = p.x0
#        c_size = p.beq.size + p.b.size
#        if p.userProvided.c: c_size += p.c(x0).size
#        if p.userProvided.h: c_size += p.h(x0).size
#        algencan.param['rho'] = ones(c_size)
#
#        algencan.param['iprint'] = 0
#        algencan.param['IPRINT'] = 0
        ...
        pywrapper.solver(evalf,evalg,evalh,evalc,evaljac,evalhc,evalfc,evalgjac,evalhl,
